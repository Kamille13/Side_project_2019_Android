...
public class ApiJsonDvf {
    ...
    public static void extractAPI2(Context context, Boolean dropoff, int zoom, final Dvf.DvfListener listener) {
        String json = null;
        RequestQueue requestQueue = Volley.newRequestQueue(context);
        String url = "http://api.cquest.org/dvf?code_postal=31400";
